...
?>
		<form method="POST">
			...
			<div id="endwid">
				...
				<label for="scd_widget_selector" style="display:none;"> <?php  __( 'Select a country here...', 'scd_wcfm_marketplace' )  ?></label>
			</div>
            <!--<input type="submit" value="<?php //echo WIDGET_BUTTON; ?>" id="scd_widget_upd" style="float: right;width: 100%;">-->
